...
{% include message_box.html type="important" title="Using Testflight" content="If you wish to invite external testers using Testflight, you CAN'T use the **ad-hoc** export method. You need an .ipa with the **app-store** export method."%}
